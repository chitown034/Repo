...
uv pip install --python ~/Applications/CLI-Anything/.venv/bin/python ./integrations/cli-anything-harnesses/showingtime/agent-harness
ln -sf ~/Applications/CLI-Anything/.venv/bin/cli-anything-showingtime ~/.local/bin/cli-anything-showingtime
cli-anything-showingtime --help        # exits 0; the word "act" appears nowhere
```
