"""Offline tests for cli-anything-showingtime — synthetic trees, no network, no Chrome, no live site.

Every DOMShell-facing call goes through one seam (``showingtime_cli._live_source``),
...
Usage:
    python -m pytest cli_anything/showingtime/tests/test_core.py -v
"""
...
from cli_anything.showingtime import CLI_NAME, SITE
from cli_anything.showingtime import showingtime_cli as cli_mod
...
from cli_anything.showingtime.core.tree import FixtureTree, parse_entry, parse_entries
from cli_anything.showingtime.utils import security
