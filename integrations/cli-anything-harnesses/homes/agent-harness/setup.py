#!/usr/bin/env python3
"""cli-anything-homes — read-only homes.com recipes over cli-anything-browser.
...
README = ROOT / "cli_anything/homes/README.md"
...
setup(
    ...
    version="0.1.0",
    description="Read-only homes.com recipes (DOMShell, via cli-anything-browser). No write verbs exist.",
    ...
    entry_points={
        "console_scripts": [
            "cli-anything-homes=cli_anything.homes.homes_cli:main",
        ],
    },
    package_data={
        "cli_anything.homes": [
    ...
    zip_safe=False,
    keywords="cli homes real-estate domshell read-only ai-agent",
    classifiers=[
