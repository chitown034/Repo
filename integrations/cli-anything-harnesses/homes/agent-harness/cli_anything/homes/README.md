...
uv pip install --python ~/Applications/CLI-Anything/.venv/bin/python ./integrations/cli-anything-harnesses/homes/agent-harness
ln -sf ~/Applications/CLI-Anything/.venv/bin/cli-anything-homes ~/.local/bin/cli-anything-homes
cli-anything-homes --help        # exits 0; the word "act" appears nowhere
```
