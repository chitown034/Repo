...
README = ROOT / "cli_anything/skyslope/README.md"
...
setup(
    ...
    version="0.1.0",
    description="Read-only, ECC-gated CLI-Anything harness for SkySlope (DOMShell). No act group.",
    ...
    entry_points={
        "console_scripts": [
            "cli-anything-skyslope=cli_anything.skyslope.skyslope_cli:main",
        ],
    },
    package_data={
        "cli_anything.skyslope": ["skills/*.md", "paths.json", "README.md", "tests/TEST.md"],
    },
    include_package_data=True,
    zip_safe=False,
    keywords="cli skyslope real-estate domshell read-only ai-agent",
    classifiers=[
