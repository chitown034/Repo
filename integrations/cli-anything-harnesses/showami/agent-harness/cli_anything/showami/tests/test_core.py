"""Offline tests for cli-anything-showami — synthetic trees, no network, no Chrome, no live site.

Every DOMShell-facing call goes through one seam (``showami_cli._live_source``),
...
Usage:
    python -m pytest cli_anything/showami/tests/test_core.py -v
"""
...
from cli_anything.showami import CLI_NAME, SITE
from cli_anything.showami import showami_cli as cli_mod
...
from cli_anything.showami.core.tree import FixtureTree, parse_entry, parse_entries
from cli_anything.showami.utils import security
