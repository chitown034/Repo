#!/usr/bin/env python3
"""cli-anything-showami — read-only Showami recipes over cli-anything-browser.
...
README = ROOT / "cli_anything/showami/README.md"
...
setup(
    ...
    version="0.1.0",
    description="Read-only Showami recipes (DOMShell, via cli-anything-browser). No write verbs exist.",
    ...
    entry_points={
        "console_scripts": [
            "cli-anything-showami=cli_anything.showami.showami_cli:main",
        ],
    },
    package_data={
        "cli_anything.showami": [
            "paths.json",
            "README.md",
            "skills/*.md",
            "tests/TEST.md",
    ...
    zip_safe=False,
    keywords="cli showami real-estate domshell read-only ai-agent",
    classifiers=[
