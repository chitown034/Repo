> Vendored from https://github.com/addyosmani/agent-skills/blob/main/references/performance-checklist.md — fetched 2026-09-22 by V2; upstream text below is unmodified.
> License: MIT License, Copyright (c) 2025 Addy Osmani (upstream LICENSE, verified 2026-09-22).
> Referenced by the vendored `security-and-hardening` and `code-review-and-quality` skills as `../../references/performance-checklist.md`.
