...
| O-11 | **Follow Up Boss → Lofty** (decided 2026-09-22); FUB API "Invalid API Key" since 2026-09-16; Composio still says ACTIVE | FUB is now bundled inside **Zillow Pro, nationwide 2026-07-09** (Inman); FUB terms updated 2025-11-03 for Zillow Pro; FUB AI (Smart Messages, Smart Summaries beta, predictive prioritization) learns from Zillow browsing. FUB public docs still document API-key Basic auth and "OAuth for newer integrations" — **no published key deprecation explains the Sep 16 failure (unverified cause)**. **Lofty**: AOS + Cowork + House.ai on **2026-07-28** (GlobeNewswire/Inman/HousingWire); AI Sales Agent (24/7 virtual ISA) **from $60/mo per 200 leads, +$30 per 100** (Luxury Presence 2026, secondary); Homeowner Agent Apr 2026 (secondary). | Decision is directionally right: FUB's roadmap is Zillow-captive; Lofty ships agentic features natively. | Complete the key + first sync; pilot Lofty AI Sales Agent against the human-ISA gap. (CAIO-11) |
...
|---|---|---|---|---|
| **Speed-to-lead / 24/7 ISA** | Lofty AI Sales Agent (24/7 qualifying + booking; from $60/mo, secondary); FUB Smart Messages (2× response rate, Zillow AI, Aug 2026 page); **UWM Mia** voice LO assistant — 2026-05-14 upgrades: Mia On Demand, pre-qual follow-up, Mortgage Review, Mia Español; "80,000+ loans closed in 12 months" (HousingWire, snippet). | Human ISA has posted nothing since 2026-09-16; r2-lead-response-watchdog and lead-triage-daily auth-failed since 2026-09-16 (FUB); `leadResponse` doc last 2026-09-22 03:02Z from the broken source; Vanessa iMessage inbox polls hourly 7:30–21:30 PT; **no outbound phone agent** ("still open" on the deck). | **Largest gap.** Competitors answer in seconds by voice/text at all hours; Steven's loop is hourly polling on a dead CRM feed. | Pilot Lofty AI Sales Agent for real-estate leads (Vanessa QA + escalation); ask Patriot Pacific whether Mia is available to the brokerage for mortgage leads (unverified). (CAIO-11, CAIO-12) |
...
**1. Close the speed-to-lead gap with a vendor ISA layer, not more polling (CAIO-11, PILOT).** The market answers leads in seconds by text and voice at all hours — Lofty's AI Sales Agent (from $60/mo, secondary source) and UWM's Mia (upgraded 2026-05-14) — while Steven's lead loop has been dead since 2026-09-16 (FUB auth failure, silent ISA, hourly polling). Once the Lofty key lands, pilot the AI Sales Agent for real-estate leads with Vanessa as QA/escalation and Alexandra's consent review up front. It is the only item that plausibly moves revenue.
